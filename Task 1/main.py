...
entry_amplitude = Entry(window, textvariable=amplitude)
entry_amplitude.config(bg="lightgreen", fg="black")
entry_amplitude.grid(row=1, column=1)

entry_analongFrequency = Entry(window, textvariable=analogFrequency)
entry_analongFrequency.config(bg="lightgreen", fg="black")
entry_analongFrequency.grid(row=2, column=1)

entry_samplingFrequency = Entry(window, textvariable= samplingFrequency)
entry_samplingFrequency.config(bg="lightgreen", fg="black")
entry_samplingFrequency.grid(row=3, column=1)

entry_phaseShift = Entry(window, textvariable= phaseShift)
entry_phaseShift.config(bg="lightgreen", fg="black")
entry_phaseShift.grid(row=4, column=1)

entry_duration = Entry(window, textvariable= duration)
entry_duration.config(bg="lightgreen", fg="black")
