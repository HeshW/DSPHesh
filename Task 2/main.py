...
# Button to open file
open_button = Button(window, text="Open File", command=open_file,bg="lightgreen")
...
clear_button = Button(window, text="Clear List", command=clear_list,bg="lightgreen")
clear_button.grid(row=2, column=0, padx=10, pady=10)

# Button to add signals
add_button = Button(window, text="Add Signals", command=add_signals,bg="lightgreen")
add_button.grid(row=3, column=0, padx=10, pady=10)

# Button to subtract signals
subtract_button = Button(window, text="Subtract Signals", command=subtract_signals,bg="lightgreen")
...
multiply_button = Button(window, text="Multiply Signal", command=multiply_signal,bg="lightgreen")
multiply_button.grid(row=6, column=0, padx=10, pady=10)

# Button to square the signal
square_button = Button(window, text="Square Signal", command=square_signal,bg="lightgreen")
...
shift_button = Button(window, text="Shift Signal", command=shift_signal,bg="lightgreen")
...
normalize_button = Button(window, text="Normalize Signal", command=normalize_signal,bg = "lightgreen")
normalize_button.grid(row=12, column=0, padx=10, pady=10)

# Button to accumulate the signal
accumulate_button = Button(window, text="Accumulate Signal", command=accumulate_signal,bg="lightgreen")
